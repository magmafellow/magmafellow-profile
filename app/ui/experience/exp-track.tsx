    ...
    <div className={`${styles.track}`}>
      ...
      <AppearShadow id="appear_exp_1">
        <div className={`${styles.track_item}`}>
          ...
          <div className={`${styles.track_item_content}`}>
            Here I acquire knowledge about building UI blocks in tandem
            HTML+CSS.
          </div>
          <div className={`${styles.track_item_hr}`}></div>
          <div className={`${styles.track_item_tech}`}>
      ...
      <AppearShadow id="appear_exp_2">
        <div className={`${styles.track_item}`}>
          ...
          <div className={`${styles.track_item_content}`}>
            It is time to React... I respect modular concept of programming.
            React gracefuly deals with it. Creating components and combine them
            is fruitful.
          </div>
          <div className={`${styles.track_item_hr}`}></div>
          <div className={`${styles.track_item_tech}`}>
          ...
          <div className={`${styles.track_item_content}`}>
            It is very convenient tool for styling your component and plane
            HTML. After using this I do not imagine my development flow without
            it.
          </div>
          <div className={`${styles.track_item_hr}`}></div>
          <div className={`${styles.track_item_tech}`}>
          ...
          <div className={`${styles.track_item_content}`}>
            One of the most trusted and robust Database Manager Systems. I
            respect Postgresql.
          </div>
          <div className={`${styles.track_item_hr}`}></div>
          <div className={`${styles.track_item_tech}`}>
      ...
      <AppearShadow id="appear_exp_3">
        <div className={`${styles.track_item}`}>
          ...
          <div className={`${styles.track_item_content}`}>
            ...
            decent full-stack applications. It offers effectivly what a
            developer might request from a framework. Constantly evolving
          </div>
          <div className={`${styles.track_item_hr}`}></div>
          <div className={`${styles.track_item_tech}`}>
            <div className={`${styles.track_item_tech_icons}`}>
      ...
      <AppearShadow id="appear_exp_4">
        <div className={`${styles.track_item}`}>
          ...
          <div className={`${styles.track_item_content}`}>
            For now I am trying to combine all present skills and technologies
            for building fast, robust and engaging projects. Meantime I learn
            something new to evolve myself. Check my GitHub, Blog and other
            social platforms to be up-to-date with me.
          </div>
        </div>
      </AppearShadow>
