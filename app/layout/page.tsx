...
export default function Page() {
  return (
    <>
      ...
      <div className={`${styles.profile}`}>
        ...
        <div className={`${styles.profile_me}`}>
          ...
          <p className={`${styles.profile_me_info} ${styles.p_limited}`}>
            ...
            have something that matches my skills and experience do not hesitate
            to contact me.
          </p>
        </div>
            ...
            <div className={`${styles.projects_item}`}>
              ...
              <div className={`${styles.projects_infoBox}`}>
                ...
                <p className={`${styles.projects_description}`}>
                  ...
                  of how you interact with it. In this app a thing around which
                  everything revolves is a chat
                </p>
      ...
      <div className={`${styles.info_card} shim-hover animate an_rapid`}>
